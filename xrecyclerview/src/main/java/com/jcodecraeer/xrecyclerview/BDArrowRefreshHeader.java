...
public class BDArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public BDArrowRefreshHeader(Context context) {
        super(context);
        initView();
    }
     ...
     * @param attrs
     */
    public BDArrowRefreshHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
     ...
     * 设置更新文案
     */
    public void setUpdateText(String msg){
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
                R.layout.listview_bdheader, null);
    ...
    public void setState(int state) {
        ...
        switch(state){
            case STATE_NORMAL:
                ...
                mStatusTextView.setText("下拉刷新数据");
                break;
