...
public class BDXRecyclerView extends RecyclerView {
    ...
    private BDArrowRefreshHeader mRefreshHeader;
    ...
    public BDXRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BDXRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        if (pullRefreshEnabled) {
            mRefreshHeader = new BDArrowRefreshHeader(getContext());
    ...
    public BDArrowRefreshHeader getDefaultRefreshHeaderView(){
        if(mRefreshHeader == null){
            return null;
        }
    ...
    public void refresh() {
        if (pullRefreshEnabled && mLoadingListener != null) {
            mRefreshHeader.setState(BDArrowRefreshHeader.STATE_REFRESHING);
    ...
    public void setRefreshHeader(BDArrowRefreshHeader refreshHeader) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (
                    layoutManager.getChildCount() > 0
                            ...
                            && !isNoMore
                            && status < BDArrowRefreshHeader.STATE_REFRESHING
                    )
            {
                isLoadingData = true;
                if (mFootView instanceof LoadingMoreFooter) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isOnTop() && pullRefreshEnabled && appbarState == AppBarStateChangeListener.State.EXPANDED) {
                    ...
                    if (mRefreshHeader.getVisibleHeight() > 0 && mRefreshHeader.getState() < BDArrowRefreshHeader.STATE_REFRESHING) {
                        return false;
                    }
                }
                break;
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    BDXRecyclerView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    BDXRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
    ...
    public void setUpdateMsg(String msg){
        if(mRefreshHeader!=null){
            mRefreshHeader.setUpdateText(msg);
        }
    }
}